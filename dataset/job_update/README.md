...
python -m job_update.cli run-data-stream `
...
python -m job_update.cli init-manual-workspace `
...
```powershell
python -m job_update.cli run-manual `
  --workspace "manual_input_workspace" `
  --month-start 2024-12 `
  --month-end 2026-07 `
  --pass-threshold 0.9
...
```powershell
python -m job_update.cli analyze-event-stream `
...
```powershell
python -m job_update.cli compare-answer `
