...
```powershell
python -m job_update.cli rebuild-skill-pool --skill-universe "B:\揭榜挂帅\dataset\岗位数据流生成系统\outputs\skill_trend_design.csv"
python -m job_update.cli rebuild-frequency --event-stream data\base\job_update_event_stream.csv --output data\base\job_skill_monthly_frequency.csv
python -m job_update.cli rebuild-lifecycle
python -m job_update.cli rebuild-migration
